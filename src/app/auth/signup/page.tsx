...
//   title: "Next.js SignUp Page | erpVnext - Next.js Dashboard ",
//   description: "This is Next.js SignUp Page erpVnext Dashboard ",
//   // other metadata
// };
...
const SignUp: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (state && state.message) {
      ...
      if (state.message == "A user with this email already exists.") {
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <form action={action}>
              ...
              {state?.errors?.name && <p className="text-red">{state.errors.name}</p>}
                ...
                <div>
                  ...
                  <ul>
                    {state.errors.password.map((error) => (
                      <li className="text-red" key={error}>- {error}</li>
                    ))}
                  </ul>
                </div>
              )}
